/*
  ...
  - You are about to drop the column `trips_id` on the `activities` table. All the data in the column will be lost.
  - You are about to drop the column `trips_id` on the `links` table. All the data in the column will be lost.
  - You are about to drop the column `trips_id` on the `participants` table. All the data in the column will be lost.
